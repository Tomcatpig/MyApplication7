...
// handler处理
    ...
    XRecyclerView xRecyclerView = rootView.findViewById(R.id.piandan_fragment_recyclerView);
    ...
    private void getData(final int offset) {
        new Thread(new Runnable() {
            @Override
            public void run() {
                String url = "http://api-xl9-ssl.xunlei.com/sl/xlppc.playlist.api/v1/list?uid=572443284&offset="+offset+"&limit=15";
